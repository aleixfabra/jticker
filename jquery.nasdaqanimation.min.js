...
b.el.on("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",e),e())}}};c.fn.nasdaqAnimation=function(){var d;return this.each(function(){var a;a=c(this);a={container:a,el:a.children("span").first(),duration:a.data().duration||50,loop:a.data().loop||1,effect:a.data().effect||""};d=new f(a);d.initialize()})}})(jQuery);